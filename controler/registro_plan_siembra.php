...
$sql="INSERT into plan_siembra (cedula,nombres,apellidos,telefono,celular,email,parroquia,eje,sector,movimiento,espacio,luz,internet,agua,tipo_proyecto) VALUES ('$cedula','$nombre','$apellido','$telefono','$celular','$email','$parroquia','$eje','$sector','$moviemiento','$espacio','$electricidad','$internet','$agua','$tipo_proyecto')";
...
$estados=pg_query($conexion,$sql);
		...
		echo '  <script type="text/javascript">
			     		 alert("Usted ya se Encuentra Registrado en el Plan Siembra Caracas");
			        	 document.location.href ="../index.html";
			        </script>';
	}
